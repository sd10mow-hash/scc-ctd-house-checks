...
v1.5.8: client Required/Not Required, PIN-gated property edits/deletes, ordered houses, route picker/base locations, full dynamic report image with Remarks lines.

PHONE UPDATE: after uploading v1.5.8, open https://sd10mow-hash.github.io/scc-ctd-house-checks/?build=1.4.3 directly in Safari. This build uses versioned assets and includes a safe Refresh App Files button.
