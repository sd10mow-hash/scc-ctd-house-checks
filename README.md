...
- Existing installations upgraded to v1.5.8 ask “Who is using this phone?” after the next successful PIN unlock.
...
- The previously emailed Clean Inspection State .sccbackup is compatible with v1.5.8.
